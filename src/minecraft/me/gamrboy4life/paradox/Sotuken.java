...
public class Sotuken {
    ...
    public static final Sotuken INSTANCE = new Sotuken();
    
    public static final Sotuken getInstance() {
        return INSTANCE;
    }
    ...
    public static void startClient() {
        ...
        SplashProgress.setProgress(8, "EduCraft - Discord RP");        
        discordRP.start();
    ...
    public static void stopClient() {
        Sotuken.instance.fileManager.saveMods();
    }
