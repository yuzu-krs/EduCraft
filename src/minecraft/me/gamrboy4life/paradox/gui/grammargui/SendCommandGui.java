...
public class SendCommandGui extends GuiScreen {

    private static final ResourceLocation IMAGE = new ResourceLocation("yuzuclient/sendCommand.png");
    ...
    private SendCommand module;
    public SendCommandGui(SendCommand module) {
    	this.module=module;
    }
