...
public class MscanfGui extends GuiScreen {

    private static final ResourceLocation IMAGE = new ResourceLocation("yuzuclient/m_scanf.png");
    ...
    private Mscanf module;
    public MscanfGui(Mscanf module) {
    	this.module=module;
    }
