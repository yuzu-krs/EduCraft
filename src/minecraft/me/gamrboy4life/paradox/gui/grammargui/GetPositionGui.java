...
public class GetPositionGui extends GuiScreen {

    private static final ResourceLocation IMAGE = new ResourceLocation("yuzuclient/getPosition.png");
    ...
    private GetPosition module;
    public GetPositionGui(GetPosition module) {
    	this.module=module;
    }
