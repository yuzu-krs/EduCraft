...
public class CloneGui extends GuiScreen {

    private static final ResourceLocation IMAGE = new ResourceLocation("yuzuclient/clone.png");
    ...
    private Clone module;
    public CloneGui(Clone module) {
    	this.module=module;
    }
