	...
	public void draw() {
		if(this.isToggled()) {
			...
			if(expanded) {
				...
				Gui.drawRect(68, 20, 48+maxLenModule+30, 25+modules.size()*13, 0x90000000);
				Gui.drawRect(70, 23+category.moduleIndex*13, 63+maxLenModule+12, 34+category.moduleIndex*13,0xFF006400);
