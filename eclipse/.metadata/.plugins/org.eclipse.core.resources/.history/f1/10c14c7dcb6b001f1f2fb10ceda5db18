...
public class SetBlockGui extends GuiScreen {

    private static final ResourceLocation IMAGE = new ResourceLocation("yuzuclient/setBlock.png");
    ...
    public SetBlockGui(SetBlock module) {
    	this.module=module;
    }
