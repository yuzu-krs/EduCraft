...
public class TestForBlocksGui extends GuiScreen {

    private static final ResourceLocation IMAGE = new ResourceLocation("yuzuclient/testforblocks.png");
    ...
    private TestForBlocks module;
    public TestForBlocksGui(TestForBlocks module) {
    	this.module=module;
    }
