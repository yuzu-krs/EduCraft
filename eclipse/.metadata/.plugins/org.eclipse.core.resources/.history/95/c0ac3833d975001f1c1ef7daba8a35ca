...
public class TestForBlockGui extends GuiScreen {

    private static final ResourceLocation IMAGE = new ResourceLocation("yuzuclient/testforblock.png");
    ...
    private TestForBlock module;
    public TestForBlockGui(TestForBlock module) {
    	this.module=module;
    }
